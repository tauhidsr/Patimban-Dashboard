...
<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="GET" action="{{ route('citizen-events.index') }}"
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                Filter berdasarkan status, atau cari nama/NIK/jenis/dusun/rw/rt/keterangan.
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 md:flex-row md:items-center">
                            <input
                                ...
                                name="q"
                                value="{{ $q }}"
                                class="text-sm border-gray-300 rounded md:min-w-[260px]"
                                placeholder="Cari nama / NIK / jenis / wilayah..."
                            />

                            <select name="status" class="text-sm border-gray-300 rounded md:min-w-[180px]">
                            ...
                            <button type="submit"
                                class="px-3 py-2 text-sm font-semibold text-white bg-indigo-600 rounded hover:bg-indigo-700">
                                Terapkan
                            </button>

                            <a href="{{ route('citizen-events.index') }}"
                                class="px-3 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50">
                                Reset
                            </a>
                        </div>
                    </form>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @forelse ($events as $index => $event)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-3 py-2 font-mono text-xs">
                                            {{ $event->nik ?? optional($event->citizen)->nik ?? '-' }}
                                        </td>
                                        ...
                                        <td class="px-3 py-2">
                                            @php
                                                $sv = $event->status_verifikasi ?? 'pending';
                                            @endphp
                                            <span class="inline-flex items-center px-2 py-0.5 text-xs font-semibold rounded-full
                                                @switch($sv)
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-3 py-8 text-sm text-center text-gray-500">
